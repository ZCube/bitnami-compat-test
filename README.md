...
* result
    ...
    | discourse  | Goss    |  :x: |  |      |                  |                  |               |
    | discourse  | Cypress |  :heavy_check_mark: | :x: |      |                  |                  |               |
    ...
    | mongodb-sharded  | Goss    |  :x: | :heavy_check_mark: | :x:     |                  |                  |               |
    ...
    | rabbitmq  | Goss    |  :heavy_check_mark: |  | :x:     |                  |                  |               |
    | rabbitmq  | Cypress |  :heavy_check_mark: | :x: |      |                  |                  |               |
    | rabbitmq-cluster-operator  | Goss    |  :x: |  |      |                  |                  |               |
    | rabbitmq-cluster-operator  | Cypress |  :x: | :x: |      |                  |                  |               |
